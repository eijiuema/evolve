...
# Public properties
var is_flat setget set_orientation, get_orientation
...
func pixel_to_hex(pos):
	var pt = Vector2((pos.x - _origin.x) / _size.x, (pos.y - _origin.y) / _size.y)
